...
public class ControlHelicopter : MonoBehaviour
{
	public AudioSource HelicopterSound;     
	public ControlPanelStage ControlPanel;       
	public Rigidbody HelicopterModel;       
	public HeliRotorController MainRotorController;     
	public HeliRotorController SubRotorController;    
	public LeftJoystick joystick;
	public RightJoystick joystick2;
	...
	private void OnKeyPressed(PressedKeyCode[] obj)
	{
		...
		{ 
			...
			if (!IsOnGround) { //forward&back&left&right&turn
		...
		OnJoyStick(ref tempX, ref tempY);
